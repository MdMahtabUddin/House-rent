              ...
              <TableBody>
                {displayPayments.map((payment) => (
                  <TableRow key={payment._id} className="hover:bg-violet-50/30 dark:hover:bg-violet-900/10 border-b border-gray-50 dark:border-gray-800/50 transition-colors">
                    ...
                    <TableCell>
                      <DropdownMenu>
                        <DropdownMenuTrigger className={buttonVariants({ variant: "outline", size: "sm", className: "h-8 gap-2 bg-white dark:bg-gray-950 border-violet-200 dark:border-violet-900 hover:bg-violet-50 dark:hover:bg-violet-900/30 text-violet-700 dark:text-violet-300 transition-all rounded-lg" })}>
